...
const dummyPosts = [
  {
    id: 1,
    user: { name: "Anurima Dutta", headline: "CEO/Founder at Global Connect", avatar: "https://placehold.co/40x40/E3245B/FFFFFF?text=AD" },
    timestamp: "3h ago",
    ...
    image: "https://placehold.co/600x300/8224E3/FFFFFF?text=Funding+Announcement",
    likes: 125,
    comments: 42,
  },
  {
    id: 2,
    user: { name: "Harish Neelam", headline: "2nd Year SEO @Tech Solutions", avatar: "https://placehold.co/40x40/2EAE2F/FFFFFF?text=HN" },
    timestamp: "5d ago",
...
const PostCreator = () => (
  <div className="gc-card gc-p-4" style={{ marginBottom: '1rem' }}>
    <div className="gc-flex gc-align-center gc-space-x-2" style={{ marginBottom: '0.75rem' }}>
      <img 
        src="https://placehold.co/48x48/54595F/FFFFFF?text=You" 
        alt="User Avatar" 
    ...
    <div className="gc-flex gc-justify-between" style={{ color: 'var(--gc-color-text-muted)', fontSize: '0.875rem' }}>
      <button className="gc-flex gc-align-center gc-space-x-2 gc-p-2 gc-btn-base" style={{ borderRadius: '4px' }}>
      ...
      <button className="gc-flex gc-align-center gc-space-x-2 gc-p-2 gc-btn-base gc-lg-hidden" style={{ borderRadius: '4px' }}>
...
const Post = ({ post }) => (
  <div className="gc-card" style={{ marginBottom: '1rem', padding: 0 }}>
    ...
    <div className="gc-flex gc-align-start gc-justify-between gc-p-4">
      ...
      <button className="gc-btn-base" style={{ color: 'var(--gc-color-text-muted)' }}>...</button>
    </div>
